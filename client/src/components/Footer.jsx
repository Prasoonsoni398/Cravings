          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link to="/order-now" className={linkClass}>
                    Order Now
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link to="/register/restaurant" className={linkClass}>
                    Partner With Us
                  </Link>
                </li>
                <li>
                  <Link to="/restaurant-dashboard" className={linkClass}>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link to="/register/rider" className={linkClass}>
                    Become a Rider
                  </Link>
                </li>
                <li>
