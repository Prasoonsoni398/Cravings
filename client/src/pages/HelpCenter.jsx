...
const faqs = [
  [
    ...
    "Go to your dashboard and open the active order to see live tracking.",
  ],
  [
    "How do I get a refund?",
    "Submit a ticket with your Order ID and our team will process it within 2-3 business days.",
  ],
  [
  ...
  return (
    <main className="flex min-h-[90vh] items-center justify-center bg-[url('/HelpPage.jpg')] bg-cover bg-center p-6 md:p-10">
      <div className="w-full max-w-5xl overflow-hidden rounded-xl bg-black/60 shadow-xl backdrop-blur-sm">
        ...
        <p className="mb-6 px-10 text-center text-(--color-secondary-content)">
        ...
        <div className="flex flex-col divide-y divide-gray-200/80 px-0 md:flex-row md:divide-x md:divide-y-0">
          <div className="px-8 pb-8 md:w-1/2 md:px-10">
            <h2 className="mb-4 text-sm font-semibold uppercase tracking-wide text-(--color-neutral-content)">
            ...
            <div className="flex flex-col gap-2">
              {faqs.map(([question, answer], index) => (
                <div
                  key={question}
                  className="overflow-hidden rounded-md border border-base-100"
                >
                  <button
                    type="button"
                    onClick={() =>
                  ...
                  {activeFaq === index && (
                    <p className="bg-base-100/30 px-4 pb-3 text-sm text-(--color-secondary-content)">
                      {answer}
                    </p>
                  )}
                </div>
          ...
          <div className="px-8 pb-8 md:w-1/2 md:px-10">
            ...
            <form onSubmit={handleSubmit}>
              <input
                className="mb-4 w-full rounded-md border border-(--color-base-300) bg-base-100/60 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-primary"
              ...
              />
              <textarea
                className="mb-6 w-full resize-none rounded-md border border-(--color-base-300) bg-base-100/60 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-primary"
                rows={4}
