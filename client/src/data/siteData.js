...
export const testimonials = [
  {
    name: "Priya Sharma",
    role: "Food Lover",
    text: "Cravings has become my daily go-to. The food arrives hot, the options are great, and ordering is effortless.",
  },
  {
    name: "Rahul Mehta",
    role: "Restaurant Partner",
    text: "The platform helped us reach more customers while keeping the order flow simple for our team.",
  },
  {
    name: "Aisha Khan",
    role: "Regular Customer",
    text: "Fast delivery, clear tracking, and dependable support. It feels made for busy days.",
  },
];
