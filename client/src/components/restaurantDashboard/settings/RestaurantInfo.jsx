  ...
  return (
    <>
      <div className="overflow-y-auto h-full p-2 space-y-2">
        ...
        <div className="bg-(--color-base-100) rounded-lg p-3 flex items-center gap-3 border border-primary/30">
        ...
        {isLoadingRestaurant ? (
          <div className="flex flex-col justify-center items-center h-64 border border-primary/30">
          ...
          <div className="bg-(--color-base-100) rounded-lg p-3 border border-primary/30">
