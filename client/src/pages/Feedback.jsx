    ...
    <main className="flex h-[90vh] items-center justify-end bg-[url('/FeedbackPage.jpeg')] bg-cover bg-center p-6 md:p-10 md:pe-30">
      <div className="max-h-[85vh] w-full max-w-md overflow-y-auto rounded-lg bg-base-100 px-8 py-6 shadow-md md:px-10">
        ...
        <form onSubmit={handleSubmit}>
          <label className="mb-2 block font-semibold text-(--color-neutral)">
            Full Name
          </label>
          <input
            className="mb-4 w-full rounded-md border border-(--color-base-300) px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-primary"
          ...
          <div className="mb-4 flex items-center gap-6">
            <label className="font-semibold text-(--color-neutral)">
              Overall Rating
            </label>
            <div className="flex gap-1">
              {[1, 2, 3, 4, 5].map((star) => (
                ...
                >
                  <FaStar
                    className={star <= rating ? "bg-warningg" : "text-gray-300"}
                  />
                </button>
              ))}
            </div>
          ...
          <textarea
            className="mb-6 w-full resize-none rounded-md border border-(--color-base-300) px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-primary"
            rows={3}
